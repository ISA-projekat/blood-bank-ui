                ...
                <div>
                    ...
                    <div>
                        <form onSubmit={this.onFilterSubmit}>
                            <label>
                                Rating:
                                <input type="number" value={this.state.rating} onChange={this.onFormRatingChange} />
                            </label>
                    ...
                    <ul>
                    {
                        this.state.bloodbanks.map((bb) =>
                            <li key={bb.id}>
                                Name: {bb.name}<br />
                                Rating: {bb.rating} <br />
                                Address: {bb.address.street} {bb.address.number}, {bb.address.city}, {bb.address.country}
                            </li>
                        )
                    }
                    </ul>
